...
class Scholarship(Base):
    ...
    eligible_states = Column(String(255), nullable=True)
    eligible_categories = Column(String(255), nullable=True)
    ...
    status = Column(String(50), default="verified", nullable=True)
    created_at = Column(DateTime, default=now_utc, nullable=False)
